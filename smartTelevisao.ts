...
class SmartTelevisao extends Televisao {
  private aplicativos: string[];
  private aplicativoAtual: string | null;
  ...
  public acessarAplicativo(numero: number): void {
    if (this.ligada) {
  ...
  private exibirSeriesNetflix(): void {
  ...
  private exibirSeriesAmazonPrime(): void {
  ...
  private exibirSeriesHBOMax(): void {
  ...
  private selecionarTemporada(totalTemporadas: number): void {
  ...
  private selecionarEpisodio(): void {
